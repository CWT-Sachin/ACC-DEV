...
public partial class RefPort
{
    ...
    [InverseProperty("FinalFDNNavigation")]
    public virtual ICollection<TxnBLStatus> TxnBLStatuses { get; } = new List<TxnBLStatus>();

    [InverseProperty("Leg2PortofDischargeNavigation")]
    public virtual ICollection<TxnBLStatus> Leg2BLStatuses { get; } = new List<TxnBLStatus>();

    [InverseProperty("Leg3PortofDischargeNavigation")]
    public virtual ICollection<TxnBLStatus> Leg3BLStatuses { get; } = new List<TxnBLStatus>();

    [InverseProperty("Leg4PortofDischargeNavigation")]
    public virtual ICollection<TxnBLStatus> Leg4BLStatuses { get; } = new List<TxnBLStatus>();
}
