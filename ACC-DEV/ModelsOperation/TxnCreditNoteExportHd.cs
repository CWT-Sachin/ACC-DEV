...
[Table("Txn_CreditNoteHD_Export")]
public partial class TxnCreditNoteExportHd
{
    [Key]
    [StringLength(20)]
    ...
    //[ForeignKey("AgentID")]
    //[InverseProperty("TxnCreditNoteExportHd")]
    //public virtual RefAgent? AgentCreditNoteExportNavigation { get; set; }

    //[ForeignKey("Customer")] // Shippingline
    //[InverseProperty("TxnCreditNoteExportHd")]
    //public virtual RefShippingLine? ShippingLineCreditNoteExpNavigation { get; set; }
}
