...
public partial class RefVessel
{
    ...
    [InverseProperty("Leg2VesselNavigation")]
    public virtual ICollection<TxnBLStatus> Leg2VBLStatuses { get; } = new List<TxnBLStatus>();

    [InverseProperty("Leg3VesselNavigation")]
    public virtual ICollection<TxnBLStatus> Leg3VBLStatuses { get; } = new List<TxnBLStatus>();

    [InverseProperty("Leg4VesselNavigation")]
    public virtual ICollection<TxnBLStatus> Leg4VBLStatuses { get; } = new List<TxnBLStatus>();
