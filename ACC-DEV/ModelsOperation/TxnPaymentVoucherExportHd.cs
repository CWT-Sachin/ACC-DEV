...
public partial class TxnPaymentVoucherExportHd
{
    ...
    //[ForeignKey("AgentID")]
    //[InverseProperty("TxnPaymentVoucherExportHd")]
    //public virtual RefAgent? AgentPaymentVoucherExportNavigation { get; set; }

    //[ForeignKey("Customer")] // Shippingline
    //[InverseProperty("TxnPaymentVoucherExportHd")]
    //public virtual RefShippingLine? ShippingLinePaymentVoucherExpNavigation { get; set; }
}
