...
[Table("Txn_DebitNoteHD_Import")]
public partial class TxnDebitNoteImportHd
{
    [Key]
    [StringLength(20)]
    ...
    [ForeignKey("AgentID")]
    [InverseProperty("TxnDebitNoteImportHd")]
    public virtual RefAgent? AgentDebitNoteImportNavigation { get; set; }

    [ForeignKey("Customer")] // Shippingline
    [InverseProperty("TxnDebitNoteImportHd")]
    public virtual RefShippingLine? ShippingLineDbitNoteImpNavigation { get; set; }
}
